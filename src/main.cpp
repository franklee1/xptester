...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "KidsCoin 2017 really";
        CTransaction txNew;
        txNew.nTime = 1525874899;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1525874899;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 429738 : 429738;
  ...
  printf("block.GetHash() == %s\n", block.GetHash().ToString().c_str());
        ...
        //// debug print
 assert(block.hashMerkleRoot == uint256("0x26525e00187b103b3b6e252087598636bca68cd495b7420cc527fd7b7d83bfcb"));
